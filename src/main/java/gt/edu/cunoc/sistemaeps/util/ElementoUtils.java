...
public class ElementoUtils {
    ...
    public static int ID_ELEMENTO_TITULO = 1;

    public static final int ID_ELEMENTO_CONVOCATORIA_ANTEPROYECTO = 8;
    public static final int ID_ELEMENTO_CONVOCATORIA_ANTEPROYECTO_FIRMADA = 9;
    ...
    public static final int ID_ELEMENTO_CARTA_ACEPTACION_CONTRAPARTE = 11;
    public static final int ID_ELEMENTO_ARTICULO = 18;
    public static final int ID_ELEMENTO_TRADUCCION_ARTICULO = 19;
